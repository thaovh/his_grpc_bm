...
export class AuthController {
  ...
  async refreshToken(@Body() refreshTokenDto: RefreshTokenDto): Promise<RefreshTokenResponseDto> {
    ...
    try {
      ...
      this.logger.error('AuthController#refreshToken.error', {
        error: error.message,
  ...
  @Resource('auth')
  @ApiBearerAuth('JWT-auth')
  @ApiOperation({ summary: 'Change user password (validate with HIS and update local)' })
  ...
  async changePassword(
    ...
    this.logger.info('AuthController#changePassword.result', {
      userId,
