...
export class InventoryService implements OnModuleInit {
  ...
  async findExpMestCabinetsByHisIds(hisIds: number[]) {
    ...
    try {
      ...
      // Return empty array on error to not block UI? Or throw?
      // Better to throw so controller knows something went wrong, or return empty list.
      // The controller logic for is_sync usually catches errors.
      throw error;
    }
  }
